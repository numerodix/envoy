...
private:
  ...
  struct NullRetryPolicy : public Router::RetryPolicy {
    ...
    const std::vector<Http::RateLimitedResetHeaderParserSharedPtr>&
    rateLimitedResetHeaders() const override {
    ...
    const std::vector<Http::RateLimitedResetHeaderParserSharedPtr> ratelimited_reset_headers_{};
  };
